        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed mb-5">
              India's most trusted matrimony service helping millions find their
              perfect life partner. Begin your beautiful journey towards forever
              love.
            </p>
          ...
          {/* Links Columns */}
          <div>
            <h4 className="font-serif text-lg font-bold text-foreground mb-5">
              Quick Links
            </h4>
