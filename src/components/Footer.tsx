import { Heart, Mail, Phone, MapPin, Facebook, Instagram, Twitter, Youtube, Linkedin, ArrowRight } from "lucide-react";
...
const Footer = () => {
  const footerLinks = {
    ...
    services: [
      { name: "Matrimony Services", href: "#" },
      { name: "Wedding Services", href: "#" },
      { name: "Astrology Match", href: "#" },
      { name: "Premium Matchmaking", href: "#" },
    ],
  };
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <a href="tel:+911234567890" className="flex items-center gap-3 text-foreground hover:text-primary transition-colors">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                  <Phone className="w-4 h-4 text-primary" />
                </div>
                +91 123 456 7890
              </a>
              <a href="mailto:support@eternalbond.com" className="flex items-center gap-3 text-foreground hover:text-primary transition-colors">
                <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 animate-pulse-soft hover:animate-none"
        ...
        <div className="border-t border-primary/10 mt-10 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
            <p>© 2024 EternalBond. All rights reserved. Made with <Heart className="w-4 h-4 text-primary fill-primary inline mx-1" /> in India</p>
