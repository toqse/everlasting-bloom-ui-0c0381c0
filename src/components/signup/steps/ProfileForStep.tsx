  ...
  <>
    ...
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {PROFILE_FOR_OPTIONS.map(({ value, label, emoji }) => (
          <button
            key={value}
            type="button"
            onClick={() => onChange(value)}
            className={`flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border-2 text-center transition-all capitalize ${
              profileFor === value
